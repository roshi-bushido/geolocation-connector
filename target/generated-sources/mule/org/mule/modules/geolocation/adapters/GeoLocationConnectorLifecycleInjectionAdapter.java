...
/**
 * A <code>GeoLocationConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link GeoLocationConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-12-02T07:42:56-03:00", comments = "Build UNNAMED.2613.77421cc")
public class GeoLocationConnectorLifecycleInjectionAdapter
    extends GeoLocationConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(GeoLocationConnectorLifecycleInjectionAdapter.class);
